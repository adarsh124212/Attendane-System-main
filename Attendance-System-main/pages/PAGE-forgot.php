...
<div class="row">
  ...
  <form class="col-8 p-4" onsubmit="return forgot();">
    <img src="<?=HOST_ASSETS?>attendance_wall.webp" class="p-2 rounded-circle" style="width:128px;height:128px;background:#f1f1f1">
...
<div class="row">
  <div class="col-4" style="background:url('<?=HOST_ASSETS?>campus2.jpg') center;background-size:cover"></div>
  <div class="col-8 p-4">
    <img src="<?=HOST_ASSETS?>campus3.jpg" class="p-2 rounded-circle" style="width:128px;height:128px;background:#f1f1f1">
