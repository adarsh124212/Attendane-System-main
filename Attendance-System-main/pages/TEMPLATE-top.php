...
$_PMETA["title"] = "Attendance_Management_System";
// Define SITE_NAME if not already defined
//define('SITE_NAME', 'Your Site Name');

// Replace HOST_ASSETS, HOST_BASE, and HOST_BASE_PATH with actual values if not defined elsewhere
...
<html>
  <head>
    ...
    <!-- (A2) WEB APP & ICONS -->
    <link rel="icon" href="<?=HOST_ASSETS?>campus3.jpg" type="image/png">
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="theme-color" content="white">
    <link rel="apple-touch-icon" href="<?=HOST_ASSETS?>campus3.jpg">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="<?=SITE_NAME?>">
    <meta name="msapplication-TileImage" content="<?=HOST_ASSETS?>campus3.jpg">
